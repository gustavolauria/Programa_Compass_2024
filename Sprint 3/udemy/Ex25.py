...
for aviao in lista_avioes:
    print(f"O avião de modelo \"{aviao.modelo}\" possui uma velocidade máxima 
          de \"{aviao.velocidade_maxima}\", capacidade para \"{aviao.capacidade}\" passageiros e é da cor \"{aviao.cor}\".")