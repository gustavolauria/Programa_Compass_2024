#Crie uma classe Ordenadora que contenha um atributo listaBaguncada e que contenha os 
...
#a lista [3,4,2,1,5] e instancie um outro objeto, decrescente dessa mesma classe com uma outra listaBaguncada sendo [9,7,6,8].
